...
def approve(action: str, payload: dict) -> bool:
    ...
    # ✅ Auto-approve in deployment (Render/Railway set env vars automatically)
    if os.getenv("AUTO_APPROVE", "false").lower() == "true" or os.getenv("RENDER") or os.getenv("RAILWAY_ENVIRONMENT_NAME"):
